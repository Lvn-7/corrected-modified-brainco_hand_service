...
# 2.1 🎛️ One-shot Control Test

`brainco_hand_cli` provides a unified one-shot control interface for quickly testing a hand, finger index, position, and speed.
...
#
# finger_index: 0~5 = [Thumb, ThumbAux, Index, Middle, Ring, Pinky]
# position: 0.0 means open, 1.0 means closed, middle values such as 0.5 are allowed
# speed: 0.0~1.0, defaults to 1.0

# Move left hand finger 3 to half-closed at speed 1.0
sudo ./brainco_hand_cli left 3 0.5 1

# Open all fingers on the right hand
sudo ./brainco_hand_cli right both open

# Close both hands
sudo ./brainco_hand_cli both close

# Move all fingers on both hands to 30% closed at speed 0.8
